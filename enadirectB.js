...
async function Cours(){
    const response = await fetch ("enadirectB.json");
...
<a href="${p.lien}" class="inline-flex font-medium items-center text-fg-brand hover:underline"  target="_blank" id="lien">
        Consulter
